    ...
    <div class="center_wrap">
      ...
      <el-form :model="SpuForm" status-icon ref="SpuForm" label-width="100px">
        ...
        <el-form-item label="一级分类：" prop="category1_id">
          <el-select
            v-model="SpuForm.category1_id"
            size="small"
            @change="fnGetCategory_sub(SpuForm.category1_id, 2)"
          >
            <el-option
        ...
        <el-form-item label="二级分类：" prop="category2_id">
          <el-select
            v-model="SpuForm.category2_id"
            size="small"
            @change="fnGetCategory_sub(SpuForm.category2_id, 3)"
          >
            <el-option
        ...
        <el-form-item>
          ...
          <el-button
            ><router-link to="/home/spu" style="color:#606266"
              >取消</router-link
            ></el-button
          >
        </el-form-item>
...
export default {
  ...
  methods: {
    fnGetThisCategory() {
      this.axios
        .get(cons.apis + "/goods/" + this.edit_id + "/", {
          headers: {
    ...
    submitForm() {
      this.axios
        .put(cons.apis + "/goods/" + this.edit_id + "/", this.SpuForm, {
          headers: {
            Authorization: "Bearer " + token
          },
          responseType: "json"
